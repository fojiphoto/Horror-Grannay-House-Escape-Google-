    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
           ...
           // Debug.Log(desiredMove);
            ...
            Vector3 tempmove;
            tempmove.z = m_MoveDir.z;
            tempmove.x = m_MoveDir.x;
            ...
            //if (tempmove.z != m_MoveDir.z || tempmove.x != m_MoveDir.x)
            //    playeranim.Play("walk");
            ...
            //if (playeranim.GetBool("walk") == true) {
        ...
        private void ProgressStepCycle(float speed)
        {
          ...
          //  Debug.Log("msteps"+m_StepCycle);
         //   Debug.Log("mnext"+m_NextStep);
         //   Debug.Log("minterval"+m_StepInterval);
